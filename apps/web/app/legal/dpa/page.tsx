    ...
    <main className="max-w-3xl mx-auto px-6 py-12 text-white">
      ...
      <section className="mb-8">
        <p className="text-slate-400 mb-2">
          <strong className="text-slate-200">Effective Date:</strong> March 1, 2026
        </p>
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-400">
          <strong className="text-slate-200">Processor:</strong> StudentInvest, operator of the
          studentinvest.app platform.
        </p>
        <p className="text-slate-400 mt-2">
          <strong className="text-slate-200">Controller:</strong> The school, school district, or
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-400">
          ...
          deleted within <strong className="text-slate-200">30 days</strong>. Anonymised aggregate
